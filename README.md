...
Créer la collection Firestore "users"
...
Modifier le fichier src/firebase.js
...
javascriptconst PREDEFINED_TAGS = [
...
javascriptconst GENERIC_ACCOUNTS = {
  'prof': {
    email: 'prof@stages.local',
...
Ajouter un document dans Firestore "users" avec role: "teacher"
Ajouter l'identifiant dans GENERIC_ACCOUNTS
